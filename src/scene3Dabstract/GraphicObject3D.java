...
public abstract class GraphicObject3D {
	 ...
	 *         frame if the parent exists or in the world's coordinates
	 *         otherwise.
	 */
	 ...
	 * accurate. If a bounding box is used, there may be significant chances of
	 * false positives depending on how much of the negative space there is in
	 * the bounding box.
	 *
	 * @param x
